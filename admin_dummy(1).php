...
<ul class="navbar-nav">
  <li class="navbar-item">
    <a class="nav-link" href="home.html">HOME</a>
     ...
     <li class="navbar-item">
    <a class="nav-link" href="view_notes.php">ACCECPTED NOTES</a>
  </li>
   <li class="navbar-item">
    <a class="nav-link" href="upload_notes.php">PENDING NOTES</a>
  </li>
   <li class="navbar-item">
    <a class="nav-link" href="admin_login.html">REJECTED NOTES</a>
  </li>
<li class="navbar-item">
